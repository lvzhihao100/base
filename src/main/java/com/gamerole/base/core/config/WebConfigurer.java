...
public class WebConfigurer extends WebMvcConfigurationSupport {
    ...
    private HandlerExceptionResolver getHandlerExceptionResolver() {
        HandlerExceptionResolver handlerExceptionResolver = (request, response, handler, e) -> {
            HttpResult<Object> result = getResuleByHeandleException(request, handler, e);
     ...
     * @return
     */
    private HttpResult<Object> getResuleByHeandleException(HttpServletRequest request, Object handler, Exception e) {
     ...
     * @Reutrn void
     */
    private void responseResult(HttpServletResponse response, HttpResult<Object> result) {
